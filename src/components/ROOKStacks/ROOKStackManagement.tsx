...
import { Plus, Trash2, Play, Square, Target, Shield, Zap, Globe, Database, Cloud } from 'lucide-react';
...
interface ROOKStackManagementProps {
  stacks: Stack[];
  setStacks: React.Dispatch<React.SetStateAction<Stack[]>>;
}

const ROOKStackManagement: React.FC<ROOKStackManagementProps> = ({ stacks, setStacks }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-md">
        <h2 className="font-semibold mb-2">Add New ROOK Stack</h2>
...
export default ROOKStackManagement;